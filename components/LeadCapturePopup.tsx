      ...
      <div className="relative w-full max-w-lg bg-white rounded-[3.5rem] shadow-2xl overflow-hidden border border-slate-100 animate-in zoom-in-95 duration-500">
        ...
        {!isSubmitted ? (
          <div className="p-10 md:p-14">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-50 text-brand-600 text-[10px] font-black uppercase tracking-widest mb-6">
            ...
            <h3 className="text-3xl font-black text-slate-950 tracking-tighter mb-4 leading-tight">
              Unlock Your <br />
              <span className="text-brand-600">Digital Potential</span>
            </h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-6 py-5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-brand-600 focus:border-transparent outline-none transition-all text-sm font-bold placeholder:text-slate-300"
                  value={formData.name}
              ...
              <div className="relative">
                ...
                <select 
                  className="w-full pl-12 pr-6 py-5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-brand-600 focus:border-transparent outline-none transition-all text-sm font-bold text-slate-900 appearance-none"
              ...
              <button 
                type="submit"
                className="w-full py-5 bg-brand-gradient text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:opacity-90 transition-all shadow-xl shadow-brand-900/20 flex items-center justify-center gap-3 mt-6"
              >
          ...
          <div className="p-20 text-center animate-in zoom-in-95 duration-500">
            ...
            <h3 className="text-3xl font-black text-slate-950 tracking-tighter mb-4 uppercase">Transmission Sent</h3>
