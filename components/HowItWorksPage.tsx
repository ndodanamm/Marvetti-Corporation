  ...
  return (
    <div className="animate-in fade-in duration-500 pb-32">
      ...
      <section className="relative pt-40 pb-32 overflow-hidden bg-slate-950">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(79,70,229,0.15),transparent_70%)]"></div>
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          <h1 className="text-5xl md:text-8xl font-black text-white leading-[0.9] tracking-tighter mb-8 uppercase">
            THE MARVETTI <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-emerald-400">FRAMEWORK</span>
          </h1>
            ...
            {STEPS.map((step, idx) => (
              <div key={idx} className={`flex flex-col lg:flex-row gap-20 items-center ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                <div className="lg:w-1/2 relative">
                  <div className={`absolute -inset-10 bg-indigo-50 rounded-full blur-3xl opacity-30 ${idx % 2 !== 0 ? 'bg-emerald-50' : ''}`}></div>
                  <div className="relative p-16 rounded-[4rem] bg-slate-50 border border-slate-100 shadow-2xl overflow-hidden group">
                    ...
                    <div className="w-24 h-24 rounded-[2.5rem] bg-white shadow-xl flex items-center justify-center text-indigo-600 mb-10 group-hover:scale-110 group-hover:rotate-6 transition-all duration-700">
                      {step.icon}
                    </div>
                ...
                <div className="lg:w-1/2 space-y-8">
                  <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-indigo-50 text-indigo-700 text-[10px] font-black uppercase tracking-widest">
                    Phase Protocol v4.0
                  </div>
      ...
      <section className="py-32 bg-slate-950 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
           <h2 className="text-xs font-black text-indigo-400 uppercase tracking-[0.5em] mb-12">The Marvetti Standard</h2>
           <div className="grid md:grid-cols-3 gap-12">
              {[
                ...
                <div key={idx} className="p-12 rounded-[3.5rem] bg-white/5 border border-white/5 hover:bg-white/10 transition-all group">
                   <div className="text-indigo-400 mb-8 flex justify-center group-hover:scale-110 transition-transform">{item.icon}</div>
      ...
      <section className="py-40 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-6xl font-black text-slate-950 mb-10 tracking-tighter leading-none uppercase">
            ...
            <span className="text-indigo-600">Digital Pillar?</span>
          </h2>
