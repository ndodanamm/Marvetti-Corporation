  ...
  return (
    <div className="animate-in fade-in duration-500 pb-32 bg-slate-50 min-h-screen">
      ...
      <section className="relative pt-40 pb-32 overflow-hidden bg-slate-950">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_50%,rgba(236,27,35,0.1),transparent_70%)]"></div>
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          <h1 className="text-5xl md:text-8xl font-black text-white leading-[0.9] tracking-tighter mb-8 uppercase">
            GROW WITH <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-400 to-brand-400">MARVETTI</span>
          </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {PARTNER_BENEFITS.map((benefit, idx) => (
              <div key={idx} className="p-12 rounded-[3.5rem] bg-white border border-slate-100 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
                <div className="w-16 h-16 rounded-2xl bg-slate-100 text-slate-700 flex items-center justify-center mb-8 border border-slate-200">
                  {benefit.icon}
                </div>
      ...
      <section className="py-32 bg-slate-950 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-24">
            <h2 className="text-xs font-black text-brand-400 uppercase tracking-[0.5em] mb-4">Strategic Paths</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="p-12 rounded-[4rem] bg-white/5 border border-white/10 hover:bg-white/10 transition-all group">
              <div className="flex items-center gap-6 mb-10">
                <div className="w-20 h-20 rounded-3xl bg-brand-500/10 flex items-center justify-center text-brand-400">
                  <Users className="w-10 h-10" />
                </div>
                <div>
                  <h4 className="text-2xl font-black text-white uppercase tracking-tight">Referral Partner</h4>
                  <span className="text-[10px] font-black text-brand-400 uppercase tracking-widest">Ideal for Networkers</span>
                </div>
              </div>
            ...
            <div className="p-12 rounded-[4rem] bg-white/5 border border-white/10 hover:bg-white/10 transition-all group">
              <div className="flex items-center gap-6 mb-10">
                <div className="w-20 h-20 rounded-3xl bg-slate-800 flex items-center justify-center text-slate-400">
                  <Handshake className="w-10 h-10" />
                </div>
                <div>
                  <h4 className="text-2xl font-black text-white uppercase tracking-tight">Strategic Alliance</h4>
                  <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Ideal for Agencies</span>
                </div>
              </div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-24">
            <h2 className="text-xs font-black text-brand-600 uppercase tracking-[0.4em] mb-4">Fast-Track Onboarding</h2>
            ...
            {[
              ...
              <div key={idx} className="flex gap-8 group">
                <div className="flex flex-col items-center">
                  ...
                  {idx < 3 && <div className="w-px h-full bg-slate-100 group-hover:bg-brand-600 transition-colors"></div>}
                </div>
                <div className="pb-12">
      ...
      <section className="max-w-5xl mx-auto px-4 mb-24">
        <div className="bg-slate-800 rounded-[4rem] p-12 md:p-20 relative overflow-hidden text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-12 border border-white/5 shadow-2xl">
          ...
          <div className="relative z-10">
             ...
             <p className="text-slate-300 font-medium text-lg max-w-md">Join our elite network of professional partners and start generating value from your connections today.</p>
          </div>
          ...
          <div className="relative z-10">
             <a 
              ...
              className="px-12 py-6 bg-slate-950 text-white rounded-[2rem] font-black text-sm uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-white hover:text-slate-950 transition-all shadow-2xl border border-white/5"
             >
